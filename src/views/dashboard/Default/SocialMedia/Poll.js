...
function Poll({ blockEdit = false, enableEditing = true }) {
    ...
    padding-bottom: 0px;
      ...
      >
        ...
        >
          ...
          {/* Posts Grid */}
          <Grid container spacing={5} sx={{ px: 2, mt: 5 }}> {/* Increased spacing & added padding */}
            {listViewData.map((item) => (
              <Grid item key={item.id} xs={12} sm={6} md={4}>
                ...
                >
                  ...
                  {/* Content */}
                  <CardContent sx={{ flexGrow: 1, px: 3, py: 2 }}> {/* Added padding */}
                    <Typography
                      variant="h6"
                      fontWeight={700}
                      color="primary"
