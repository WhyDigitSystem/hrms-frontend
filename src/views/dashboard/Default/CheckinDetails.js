          ...
          <CardWrapper border={false} content={false}>
            <Box sx={{ p: 2.25 }}>
              <Grid container direction="column">
                    ...
                    <Box className="d-flex justify-content-start justify-content-lg-between align-items-center">
                      ...
                      <Button
                        ...
                        sx={{
                          mr: 2,
                          width: '120px',
                          backgroundColor: isCheckedIn ? '#d3d3d3' : '#007bff', // Light Gray when disabled, Blue when active
                      ...
                      <Button
                        ...
                        sx={{
                          width: '120px',
                          zIndex: 1,
                          backgroundColor: isCheckedIn ? '#007bff' : '#d3d3d3', // Red when active, Light Gray when disabled
                          color: isCheckedIn ? 'white' : '#6c757d',
                          cursor: isCheckedIn ? 'pointer' : 'not-allowed',
                          transition: 'transform 0.3s ease, box-shadow 0.3s ease',
                          '&:hover': {
                            backgroundColor: isCheckedIn ? '#0056b3' : '#d3d3d3',
                ...
                <Grid item sx={{ mt: 2 }}>
                  <Typography sx={{ fontSize: '1.2rem', fontWeight: 600, color: theme.palette.secondary[200] }}>Recent Activity</Typography>
                  <List>
                    <ListItem>
                      <AccessTimeIcon sx={{ mr: 2 }} color="white" />
                      <Typography sx={{ fontSize: '1rem', color: theme.palette.secondary[200] }}>Check-In for work at 9:00 AM</Typography>
                    </ListItem>
                    <ListItem>
                      <AccessTimeIcon sx={{ mr: 2 }} color="white" />
                      <Typography sx={{ fontSize: '1rem', color: theme.palette.secondary[200] }}>Check-out for work at 12:30 PM</Typography>
                    </ListItem>
                  </List>
                </Grid>
              </Grid>
