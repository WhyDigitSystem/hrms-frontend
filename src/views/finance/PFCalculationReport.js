...
const PFCalculationReport = () => {
  ...
  const listViewColumns = [
    { accessorKey: 'ipNumber', header: 'UAN', size: 140 },
    { accessorKey: 'ipName', header: 'Member Name', size: 140 },
    { accessorKey: 'daysWorked', header: 'EMP ID', size: 140 },
    { accessorKey: 'monthlyWages', header: 'Gross Wages', size: 140 },
    { accessorKey: 'reasonCode', header: 'EPF Wages', size: 140 },
    { accessorKey: 'lastWorkingDate', header: 'EPS Wages', size: 140 },
    { accessorKey: 'lastWorkingDate', header: 'EDLI Wages', size: 140 },
    { accessorKey: 'lastWorkingDate', header: 'EPF Contri Remittee', size: 140 },
    { accessorKey: 'lastWorkingDate', header: 'EPS Contri Remittee', size: 140 },
    { accessorKey: 'lastWorkingDate', header: 'EPS DIFF Remittee', size: 140 },
    { accessorKey: 'lastWorkingDate', header: 'NCP Days', size: 140 },
    { accessorKey: 'lastWorkingDate', header: 'ID OF Advantages', size: 140 },
...
export default PFCalculationReport;
