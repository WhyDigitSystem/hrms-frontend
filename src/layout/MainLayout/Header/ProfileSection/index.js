...
const ProfileSection = () => {
  ...
  // const handleDelete = (docToRemove) => {
  //   const updatedDocs = uploadedDocs.filter((doc) => doc.id !== docToRemove.id);
  ...
  //       enqueueSnackbar('success', 'Document deleted successfully');
  //       fetchUploadedDocuments(); // Refresh list
  //     } else {
  //       // showToast('error', response.paramObjectsMap?.errorMessage || 'Failed to delete');
  //       enqueueSnackbar(response.paramObjectsMap?.errorMessage || 'Failed to delete');
  //     }
  //   } catch (error) {
  //     console.error('Delete error:', error);
  //     // showToast('error', 'Error while deleting document');
  //     enqueueSnackbar('Error while deleting document');
  //   }
  // };  
